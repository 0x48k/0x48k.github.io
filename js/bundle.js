...
window.addEventListener('scroll', function () {
  if (pageYOffset > document.documentElement.clientHeight / 2) {
    if (pageYOffset > scroll) header.classList.add('hide');else if (pageYOffset < scroll - 10 || pageYOffset < document.documentElement.clientHeight / 1.5) header.classList.remove('hide');
  }
